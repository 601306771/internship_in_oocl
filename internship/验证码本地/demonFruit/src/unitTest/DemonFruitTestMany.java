...
//import com.b2brobot.binaryzation.ImageBinaryzationService;
import java.io.File;
...
public class DemonFruitTestMany {
	public static void main(String[] args) {
		String pngPath = "C:\\Users\\LINI8\\Desktop\\archive2";
		...
		for (int j = 0; j < array.length; j++) {
			...
			//get img chart 
			String key = array[j].getPath().substring(array[j].getPath().indexOf("archive2")+9,array[j].getPath().length());
