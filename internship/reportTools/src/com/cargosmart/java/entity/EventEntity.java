...
public class EventEntity implements Comparable<EventEntity> {
	...
	public EventEntity(ArrayList<String> array){
	...
	String ATA;
	String ATD;     
	public HashMap<String,StatusEntity> status = new HashMap<String,StatusEntity>();
	...
	public HashMap<String, StatusEntity> getStatus() {
		return status;
	}
	public void setStatus(HashMap<String, StatusEntity> status) {
		this.status = status;
	}
